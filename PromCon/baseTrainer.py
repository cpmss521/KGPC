...
from PromCon.opt import tensorboardX
from PromCon.utils import append_csv,create_csv,create_directories_dir,reset_logger,summarize_dict,save_dict,set_seed
...
class BaseTrainer:
    ...
    def _log_arguments(self):
        save_dict(self._log_path, self._args, 'args')
        if self._summary_writer is not None:
            summarize_dict(self._summary_writer, self._args, 'args')
